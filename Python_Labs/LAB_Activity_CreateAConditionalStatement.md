...
When OS 2 is running the code will print "no update needed", But when OS 1 is running nothing will happens.

And that's because we didn't use "else" in this scenario
...
In the setup above the code will print "no update needed" if OS 2 is running, and it will print "update needed" if OS 2 is not running
...
When OS 2 is running the code will print "no update needed", And when OS 1 or OS 3 is running it will print "update needed", but when none of those are running the code won't display any results
...
If the system is OS 2 the code will print "no update needed", but if the system is OS 1 or OS 3 it will print "update needed" and the code have been written with the condotional "or" to check for either OS 1 or OS 3 is true to proceed.
...
if username in approved_list:
    ...
    print("user does not have access to this device.")
...
When an approved user tries to login the code prints "This user has access to this device", but when an unapproved user tries to log in the code will print ""user does not have access to this device."
...
If the user logs in during oganization hours then the code will print "Login attempt made during organization hours." but if they log in outside of organization hours the code will print "Login attempt made outside of organization hours."
...
If the user is among the approved uesrs the code will print "This user has access to this device." but if the user is NOT among the approved users it the code will print "This user does not have access to this device.", and if the user tries to log in outsude of organization's hours the code will print "Login attempt made outside of organization hours."
...
If the log in attempt was made by an approved user during organization hours the code will print "Login attempt made by an approved user during organization hours.", but if either the user not on the approved list or the log in attempt was made outside of organization hours the code will print "Username not approved or login attempt made outside of organization hours."

## Conclusion
**What are your key takeaways from this lab?**

Coding in python using conditonal can set rules that needs to be met in order for something specific to happen.

for example you can set a rule that a user needs to be in an approved list to be able to log in or that the user needs to log in during working hours or an alert will be sent.
