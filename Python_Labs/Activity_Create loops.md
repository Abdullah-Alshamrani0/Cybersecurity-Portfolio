...
A while loop is different from a for loop because a while loop based on a condition, as long as the condition is true the loop will continue
...
Because it the code can print the (i) before it can checks for the conditional, and then it prints "Only 10 valid employee ids remaining", but if you add the print(i) inside the conditional the code will display unwanted results

## Conclusion
**What are your key takeaways from this lab?**

There are a lot of ways to create loops.

using for loops can help with iterate through lists and numbers. 

while loops are more complicated, you can create conditions and while the condition is true the loop will continue
