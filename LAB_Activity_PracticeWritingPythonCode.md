...
The code cell gave the output (Hello world!)
...
There was no output from the cell above, since all of the commands wriiten is a comment it didnt output any results
...
There was no output when i ran the cell above, that because the cell had a comment only
...
It gave the output "I am a security analyst.", that because (print) has been used
...
The cell above displayed the string "Python is useful for security!"
...
The cell above gave the output :
...
In python you can add a comment using the hash sign (#), you can also use the command (print) to output a string
