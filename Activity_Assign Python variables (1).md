...
The data type of device_id is a string since its in quotation marks
...
There are two (username_list) the first print was the old list and the second was the updated version
...
the data type of 'max_logins' is 'int'
...
the data type of 'login_attempts' is 'int'
...
The output is True, which means that the login attempts were less than the max logins
...
The output is 'False', which means the login attempts were higher than the maximum login attempts allowed
...
The data type of 'login_status' is 'bool', which means that its a boolean

## Conclusion

**What are your key takeaways from this lab?**

Using python you can assign and reassign variables, you can also check for the data type of a variable and detarmine whether it 'int, bool, float,' etc.
You can also check for boolean, for example in task 9, we used boolean to detarmine whether the login attempts were higher than the allowed maximum logins
